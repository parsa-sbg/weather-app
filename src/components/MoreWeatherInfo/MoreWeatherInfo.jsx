  ...
  return (
    <div className='MoreWeatherInfo'>
      ...
      <div className='MoreWeatherInfo__body'>
        <MoreWeatherInfoItem name='Temp max' value={moreWheaherInfo.maxTemp+'°'} icon={<FaTemperatureThreeQuarters size={30} color='red'/>}/>
        <MoreWeatherInfoItem name='Temp min' value={moreWheaherInfo.minTemp+'°'} icon={<FaTemperatureThreeQuarters size={30} color='blue'/>}/>
